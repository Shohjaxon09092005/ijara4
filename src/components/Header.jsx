  ...
  return (
    <header className='header'>
      ...
      <ul  className="modal__list">
          <li onClick={del}><NavLink to="/Transport">Transport vositalari</NavLink></li>
          <li onClick={del}><NavLink to='/yer'>Yer mulk</NavLink></li>
          <li onClick={del}><NavLink to='/uy'>Ko'chmas mulk</NavLink></li>
          <li onClick={del}  ><NavLink to='/Maishiy'>Maishiy texnika</NavLink></li>
          <li onClick={del}><NavLink to='/boshqa'>Boshqalar</NavLink></li>
          <li onClick={del}><NavLink to='/ijara'>Ijaraga qo'yish</NavLink></li>
